...
| **Agent** | The `dbr2-agent` instance on a Host | Lifecycle states: Pending approval → Active → Suspended / Revoked. It holds a Kopia user identity (ADR-0002). |
...
| **Application** | The logical unit of protection and recovery: a set of services and their resources that are backed up and restored together | Usually derived from a Compose Project. It can also be defined manually (a grouping of containers) or reconstructed. Carries ownership metadata: owner, environment, criticality. |
