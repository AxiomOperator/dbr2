...
func TestDiscoverHostThroughGatewayWithResume(t *testing.T) {
	...
	workflows.Register(w, &diag.Activities{}, &hosts.Activities{Control: controlv1.NewGatewayControlServiceClient(conn), Token: token, WaitForAgent: time.Minute}, nil, nil)
